 ...
 * such things.
 */
export class SingleCourse extends Component {
  state = {}
  constructor() {
    super()
  }
  ...
  render() {
    ...
    return (
      <div>    
          ...
          <Header as='h3' style={{ fontSize: '3em' }} textAlign='center'>Single Course</Header>
          </Container>
          <Grid celled>
          <Grid.Row>
            <Grid.Column width={3}>
            ...
            onChange={(order, sortable, evt) => {
                ...
                console.log("new state order: ", this.state.items);
            }}>
                {simpleList}
                {courses.map(elem => {
                  return(
            ...
            placeholder='public/assets/images/image-16by9.png'
            aspectRatio="21:9"
            url='/files/CC_FacePulls.mp4'
              />                      
